...
function SearchBar({ actions = allActions }: { actions?: Action[] }) {
        ...
        <div className="absolute z-50 left-0 right-0">
          <AnimatePresence>
            {isFocused && result && !selectedAction && (
              <motion.div
                className="border rounded-md shadow-sm overflow-hidden dark:border-gray-800 bg-white dark:bg-black mt-1"
                variants={container}
                initial="hidden"
                animate="show"
                exit="exit"
